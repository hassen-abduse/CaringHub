      ...
      <>
        ...
        <Container style={{ marginTop: "100px" }}>
          <div className="container">
            <div>
              <a
                className="btn-solid-sm mt-3 mb-3"
              ...
              <div class="container">
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <p class="p-heading">
                      We have hundreds of volunteer projects for every skill,
                      time commitment, and cause area. Find the one that excites
                      you – and complete it virtually.
                    </p>
                  </div>
                  {props.Projects.projects && (
                    <CardHolder
                      results={filterProjects(
                        props.Projects.projects,
                        project.causeAreas.map((cause) => cause._id),
                        project.skillSets.map((skill) => skill._id)
                      )}
                    />
                  )}
