      ...
      <div className="container">
        ...
        <div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-xl-6">
                <div style={{ marginTop: "1rem" }} class="text-container">
                  ...
                  <div className='mt-2'>
                    <p style={{ fontWeight: 'bold', fontStyle: 'italic' }}>Posted on: {new Intl.DateTimeFormat('en-US', { year: 'numeric', month: 'short', day: '2-digit' }).format(new Date(project.createdAt))}
                      <br></br>
                      Starts on: {new Intl.DateTimeFormat('en-US', { year: 'numeric', month: 'short', day: '2-digit' }).format(new Date(project.startDate))}
                      <br></br>
                      Ends on: {new Intl.DateTimeFormat('en-US', { year: 'numeric', month: 'short', day: '2-digit' }).format(new Date(project.endDate))}
                      </p>
                  </div>
                  {
                  ...
                  }
                  {
                    ...
                    <Alert severity="success">
                      ...
                      <strong>Thank you! {project.ownerOrg.name} will contact you soon!</strong>
                    </Alert>
                    :
                    null
                  }
          ...
          >
            ...
            <Link to={`/organization/dashboard/${project.ownerOrg._id}`}>More About {project.ownerOrg.name}</Link>
          </div>
        </div>
